Shader "Custom/Fog" // This section allows for easy sorting of our shaders in the shader menu
{
	...
	SubShader // Multiple subshaders can exist in a shader, they run at different GPU levels on different platforms
	{
		...
		#pragma surface MainColour Lambert finalcolor:FogColour vertex:Vert // the surface of our model is affected by the mainColour function. The material type is Lambert, which is a flat material with no highlights
		...
		*/
		...
		void FogColour(Input IN, SurfaceOutput o, inout fixed4 colour)
		{
			...
			float fogAlpha = _FogColour.a; // Makes fog transparent
			...
			o.Alpha = lerp(colour.a, fogAlpha, IN.fog); // Alters transparency DOES NOT WORK
		}
